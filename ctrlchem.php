...
<head>
    <meta charset="utf-8">
    <title>Controlled Chemicals - CSM Inventory System</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a style="font-family: 'Evogria', sans-serif;" href="ctrlchem.php" class="nav-item nav-link active"><i class="fas fa-vials"></i>Controlled Chem</a>
        ...
        <div class="content">
            ...
            <div style="background-color: lightgray; padding: 10px;" class="main_contents">
                <div class="container " >
                  <br>
                 <br>
                 <h5 style="font-weight: bolder; font-family: 'Evogria', sans-serif;">Controlled Chemicals</h5>
                 <!--
                ...
                -->
                <div>
                    <button class="btn btn-dark mb-3 mt-4" style="font-size:13px; font-family: 'Evogria', sans-serif;"data-bs-toggle="modal" data-bs-target="#controlledchem"><i class="fas fa-plus-circle"></i>Add</button>
                                      
                                      <div class="modal fade" id="controlledchem" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-sm">
                                          <div class="modal-content"style="background-color: lightgray;width: 387px;"class="card mt-3 shadow">
                                            <div class="modal-header">
                                              <h6 class="mb-1"style="font-weight: bolder; font-family: 'Evogria', sans-serif; ">Add Controlled Chemical</h6>
                                            </div>
                                       ...
                                       Controlled Chemical Name
                                        <input type="text" class="form-control mb-3" style="font-size:13px; width: 355px;" name="ctrlchemname" required>
                                        <select id="controlledchem" name="volmass" required>
                                        ...
                                        <input type="number" class="form-control mb-3" style="font-size:13px; width: fit-content;" name="volmass">
                                       ...
                                       class="form-control mb-3" style="font-size:13px; width: fit-content;"name="date">
                                            ...
                                            <div class="modal-footer">
                                                <div class="btn-group" style="float:right; ">
                                                    ...
                                                    <button type="submit" name="controlledchem" class="btn btn-secondary" style="font-size:14px; font-family: 'Evogria', sans-serif;">Update</button>
                                                </div>
                                            </div>
                                          </div>
                                        </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-12 col-md-6">
                        ...
                        <label>
                            <input type="search" class="form-control form-control-sm" placeholder="Search Controlled Chemicals" aria-controls="mytable">
                        </label>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th scope="col" class="sorting" tabindex="0" aria-controls="mytable" rowspan="1" colspan="1" aria-label="ControlledChem Name: activate to sort column ascending" 
                        style="font-family: 'Evogria', sans-serif;">Controlled Chemical Name</th>
                        <th scope="col" class="sorting" tabindex="0" aria-controls="mytable" rowspan="1" colspan="1" aria-label="Volume: activate to sort column ascending" 
                        style="width: 140px;font-family: 'Evogria', sans-serif;">Volume / Mass</th>
                    ...
                    <tr class="even">
                        ...
                        <td class="sorting_1">
                            <div class="btn-group">
                                <button class="btn btn-light text-primary" style="font-size:13px"data-bs-toggle="modal" data-bs-target="#editctrlchem"><i class="fas fa-edit"></i></button>
                                  
                                <div class="modal fade" id="editctrlchem" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                  <div class="modal-dialog modal-sm">
                                    <div class="modal-content"style="background-color: lightgray;width: 387px;"class="card mt-3 shadow">
                                      <div class="modal-header">
                                        <h6 class="mb-1"style="font-weight: bolder; font-family: 'Evogria', sans-serif; ">Edit Controlled Chemical</h6>
                                      </div>
                                      <div class="modal-body">
                                 ...
                                 Controlled Chemical Name
                                  <input type="text" class="form-control mb-3" style="font-size:13px; width: 355px;" name="ctrlchemname" required>
                                  <select id="editctrlchem" name="volmass" required>
                                    <option value="ml">Milliliters</option>
                                    <option value="liter">Liters</option>
                                    <option value="gal">Gallons</option>
                                    <option value="mg">Milligrams</option>
                                  ...
                                  <input type="text" class="form-control mb-3" style="font-size:13px; width: fit-content;" name="volmas">
                                 ...
                                 class="form-control mb-3" style="font-size:13px; width: fit-content;"name="date">
                                      ...
                                      <div class="modal-footer">
                                          <div class="btn-group" style="float:right; ">
                                              <a aria-label="close" data-bs-dismiss="modal" class="btn btn-light text-danger border-dark" style="font-size:12px;margin:right;">Cancel</a>
                                              <button type="submit" name="editctrlchem" class="btn btn-secondary" style="font-size:14px; font-family: 'Evogria', sans-serif;">Update</button>
                                          </div>
                                      </div>
                                    </div>
                                  </div>
